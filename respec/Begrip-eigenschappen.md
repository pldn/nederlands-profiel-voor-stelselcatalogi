...
- Een begrip kent altijd een **_definitie_** (niet persé publieksvriendelijk, maar wel altijd een verwoording van de betekenis zoals beoogd in de authentieke bronnen, zoals wet- en regelgeving, industriestandaarden, proces- en productafspraken en organisatiebeleid), deze definitie dient compleet en sluitend te zijn en voldoende informatie te bevatten om binnen het domein herkenbaar te zijn.
...
Het is een best-practice om elke resource te voorzien met een rdfs:label waarmee deze resource een voor mensen leesbare vorm kent, ongeacht de context. Elk begrip dient per taal precies één expliciet opgenomen rdfs:label te bevatten. Anders dan bij de voorkeursterm, is het verstandig om zoveel mogelijk context in het label mee te geven, zodat geen verwarring ontstaat in het kader van homoniemen (zie ook de vorige sectie). Het algemene label bevordert tevens de compatibiliteit met bestaande tools. Merk op dat het hier gaat om het expliciet opgegeven rdfs:label. Het is denkbaar dat tools andere rdfs:labels afleiden, op basis van de SKOS ontologie (aangezien alle SKOS labels subproperties zijn van rdfs:label).
...
skos:broader en skos:narrower stellen hierarchische relaties voor en worden dus gebruikt om structuur in een begrippenkader aan te brengen. Het 'hoogste' begrip (in de hierarchie van skos:broader/skos:narrower) in een begrippenkader wordt verbonden aan het begrippenkader. Het is good-practice om deze relatie van het begrippenkader naar het begrip te leggen. Hiervoor gebruiken we skos:hasTopConcept. Een hiërarchische relatie tussen twee begrippen beschrijft altijd een specifiek soort breder/smaller relatie tussen deze twee begrippen, zonder dat dit direct duidelijk is. Vaak wordt bedoeld dat sprake is van een meer specifiek begrip ten opzichte van een meer algemeen begrip. Maar ook andere soorten zijn denkbaar. Indien het wenselijk is om expliciet aan te geven wat voor soort hiërarchische relatie wordt bedoeld, kan gebruik worden gemaakt van de relaties die in ISO2594 zijn benoemd.

Het is een good-practice om hierarchische relaties van onder naar boven te leggen. Dat wil zeggen dat we de begrippen-hiërarchie opbouwen door expliciet skos:broader relaties te leggen in plaats van skos:narrower relaties. Semantisch gezien maakt dit geen verschil; skos:broader en skos:narrower zijn namelijk inverse relaties. Het is dan ook niet nodig om beide relaties op te nemen: van tools wordt verwacht dat zij, waar nodig, de navigatie "tegen de pijl in" ook ondersteunen.
Het kan voorkomen dat een begrip meerdere bredere begrippen kent.
Daarnaast is het een good-practice om semantische relaties op te nemen, zoals deze ook in de definitie terugkomen. Als in de definitie van een begrip A de begrippen B en C worden gebruikt, dan is de verwachting dat er ook een relatie A->B en A->C opgenomen wordt bij de specificatie van het begrip.
