...
* Dit document is als Nederlandse standaard voor het beschrijven van begrioppen in het Nederlands opgesteld. Alle beschrijvende kenmerken kunnen meertalig worden toegepast. Zo heeft ieder begrip 1 voorkeursterm per taal. De taal kan dan daarbij worden gespecificeerd met een taalaanduiding. Bij publicatie via het web geldt de aanduiding van de IANA(https://www.iana.org/assignments/language-subtag-registry/language-subtag-registry) (Internet Assigned Numbers Authority).
